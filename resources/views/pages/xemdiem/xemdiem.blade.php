   ...
   <style>
        ...
        <div>
            <div>
                <div
                    id="changeHeight"
                    class="section-head width_common changeHeigth"
                    
                >
                    <div class="container">
                        <h2 class="section-head__title">
                            <a href=""
                                ><span>Dữ liệu điểm thi</span>
                                <br />
                        ...
                        <div class="section-head__searchform">
                            <div class="form-group tenthisinh">
                                ...
                                />
                                <button
                                    class="btn btn--search search_submit"
                                    onclick="search()"
                                >
                                    Tìm kiếm
                                </button>
      ...
      <script>
            ...
            function showData(thong_tin,diem_thi,suggest){
                ...
                const diem_thi_body = $('#bang_diem_thi')[0]
                const goi_y_body = $('#bang_goi_y')[0]
                const 
                let row_bang_goi_y =''
                ...
                suggest.forEach(element => {
                    row_bang_goi_y += `<tr>
                                        ...
                                        <td>${element.point}<span class="plus">(${element.delta})</span></td>
                                    </tr>`
                });
               
                const row_bang_diem_thi =  
                `
                 <tr>
                    <td>${data.Ten_mon}</td>
                    <td>${data.diem}</td>
            ...
            allCities.forEach((element) => {
                const child = `<option id="${element.id}city" value="${element.place_id}">${element.place_name}</option>`;
